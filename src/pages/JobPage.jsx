...
/*
    We can easily use useEffect hook to fetch data for individual jobs here, 
    but now we prefer to use Data Loader from react router
*/
...
const JobPage = ({ deleteJob }) => {
    ...
    /* 
        -> This was the implementation using useEffect, now we will use Data Loaders for the same purpose 
        -> It's benifit is that the data extracted can be used elsewhere also
    */
  ...
  return (
    <>
    {/* We will dynamically enter data here as we have access to the jobLoader function using useLoaderData*/}
        <section>
